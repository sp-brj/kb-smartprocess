# [АРХИВ] Беклог: CRM модуль для управления проектами

> ⚠️ **Модуль удалён 2026-05-26.** См. [`docs/adr-001-remove-crm.md`](docs/adr-001-remove-crm.md).
> Файл оставлен в репозитории как историческая запись фич, которые были реализованы и затем убраны.
> Восстановить код можно из git-истории до коммита `8a47a1f`.
...
### Навигация
- [x] Обновить `Header.tsx` — переключатель модулей
- [x] CRM навигация в `/crm/layout.tsx`
- [x] Breadcrumbs в CRM

### Настройки
- [x] Страница `/crm/settings/statuses/page.tsx` — настройка статусов проектов
- [x] Drag-drop для изменения порядка статусов

### Тестирование
- [x] E2E тесты для CRM (CrmPage + navigation.spec.ts)

### Документация
- [x] Обновить `ARCHITECTURE.md` — добавить CRM модуль
- [x] Обновить `.claude/CLAUDE.md` — инструкции для CRM
